    ...
    <div class="row">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button class="btn btn-info"><a
                                            href="javascript:$('#mainId').load('${path}/banner/banner.jsp')">展示轮播图</a>
                                    </button>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button class="btn btn-warning"><a
                                            href="javascript:$('#mainId').load('${path}/user/user.jsp')">用户信息</a>
                                    </button>
                                </li>
                                <br>
                                <li>
                                    <button class="btn btn-warning"><a
                                            href="javascript:$('#mainId').load('${path}/user/goEasyEcharts.jsp')">用户统计</a>
                                    </button>
                                </li>
                                <br>
                                <li>
                                    <button class="btn btn-warning"><a
                                            href="javascript:$('#mainId').load('${path}/user/chinaJsonController.jsp')">用户分布</a>
                                    </button>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button class="btn btn-primary">上师信息</button>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="col-md-10" id="mainId">
            ...
            <div class="panel panel-footer" align="center">
                <div> 百知教育zhangcn@zparkhr.com</div>
            </div>
        </div>
    </div>
</div>
